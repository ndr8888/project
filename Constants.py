...
# фоны для экранов старта, финиша и паузы
...
# группы спрайтов
animation_group = pygame.sprite.Group()  # для БУМов магических атак
all_sprites = pygame.sprite.Group()
player_group = pygame.sprite.Group()  # игрок
entity_group = pygame.sprite.Group()  # монстры + игрок в целом
static_sprites = pygame.sprite.Group()  # для инвентаря
weapon_group = pygame.sprite.Group()  # оружия
potion_group = pygame.sprite.Group()  # зелья
...
monster_group = pygame.sprite.Group()  # монстры
spawned_monsters = pygame.sprite.Group()  # для боссов
